...
const SUITES = ["orchestrate", "advisor", "package", "agent-contract", "agent-run", "swarm", "attach-pasted", "experiment", "cleanup", "worktree", "cli", "conformance", "lock", "protocol", "fidelity", "orchestrate-live"];
