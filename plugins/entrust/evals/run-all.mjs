...
const SUITES = ["orchestrate", "package", "agent-contract", "agent-run", "attach-pasted", "experiment", "cleanup", "worktree", "cli", "conformance", "lock", "protocol", "fidelity", "orchestrate-live"];
